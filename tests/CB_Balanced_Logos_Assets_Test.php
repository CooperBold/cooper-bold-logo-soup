<?php
/**
 * Unit tests for CB_Logo_Soup_Assets conditional Splide enqueue.
 *
...
/**
 * @covers CB_Logo_Soup_Assets
 */
final class CB_Logo_Soup_Assets_Test extends TestCase {

	protected function tearDown(): void {
		parent::tearDown();
		$ref  = new ReflectionClass( CB_Logo_Soup_Assets::class );
		$prop = $ref->getProperty( 'needs_standalone_splide' );
		$prop->setValue( null, false );
	}

	public function test_content_detects_carousel_shortcode(): void {
		$content = '[logo_soup layout="carousel" logos="https://example.com/a.svg|A"]';
		$this->assertTrue( CB_Logo_Soup_Assets::content_needs_standalone_splide( $content ) );
	}
	...
	public function test_content_skips_carousel_slides_wrapper(): void {
		...
		$this->assertFalse( CB_Logo_Soup_Assets::content_needs_standalone_splide( $content ) );
	}
	...
	public function test_enqueue_frontend_sets_standalone_flag(): void {
		$this->assertFalse( CB_Logo_Soup_Assets::needs_standalone_splide() );
		CB_Logo_Soup_Assets::enqueue_frontend( true );
		$this->assertTrue( CB_Logo_Soup_Assets::needs_standalone_splide() );
	}

	public function test_enqueue_frontend_without_carousel_keeps_flag_false(): void {
		CB_Logo_Soup_Assets::enqueue_frontend( false );
		$this->assertFalse( CB_Logo_Soup_Assets::needs_standalone_splide() );
	}
	...
	public function test_raw_content_detects_shortcode_in_bricks_meta(): void {
		...
		$this->assertTrue( CB_Logo_Soup_Assets::content_needs_standalone_splide( $bricks_json ) );
	}
